@file:Suppress("unused", "unused", "unused", "unused", "MemberVisibilityCanBePrivate")
...
class Config {
    companion object {
        ...
        private fun parse(context: Context, json: JSONObject) {
            ...
            // font
            fontFamily = Utils.getString(font, "family", "system").toLowerCase()
